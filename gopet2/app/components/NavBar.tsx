...
const NavBar: React.FC = () => {
  return (
    <nav className="sticky top-4 z-[100] mx-auto flex w-[95%] max-w-[1200px] items-center justify-evenly rounded-full bg-white/90 p-2 shadow-lg backdrop-blur-md transition-all duration-300 hover:bg-white/80 border border-white/40">
  {[
