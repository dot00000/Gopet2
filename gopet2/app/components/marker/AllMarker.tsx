  ...
  return (
    <>
      <div id={mapId} className="w-full h-[1000px]">
        ...
        {/* 버튼 */}
        <button
          className={`flex font-bold justify-center items-center px-4 py-2 rounded-4xl transition ${activeType === 'cafe' ? "bg-blue-800 text-white" : "bg-white/60 text-black"}`}
        ...
        <button
          className={`flex font-bold justify-center items-center px-4 py-2 rounded-4xl transition ${activeType === "food" ? "bg-blue-800 text-white" : "bg-white/60 text-black"}`}
        ...
        <button
          className={`flex font-bold justify-center items-center px-4 py-2 rounded-4xl transition ${activeType === "hospital" ? "bg-blue-800 text-white" : "bg-white/60 text-black"}`}
        ...
        <button
          className={`flex font-bold justify-center items-center px-4 py-2 rounded-4xl transition ${activeType === "park" ? "bg-blue-800 text-white" : "bg-white/60 text-black"}`}
